...
window.onload = function () {
  ...
  function listener() {
    ...
    $main.querySelector('.search').addEventListener('input', function (e) {
      clearTimeout(input);
      var input = setTimeout(function () {
        var $target = e.target;
    ...
    $main.querySelector('.search .remove').addEventListener('click', function () {
  ...
  function searching(val) {
    ...
    try {
      for (var _iterator = postList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        var title = post.info.title.toLowerCase();
        var $post = $list.querySelectorAll('.item')[index];
