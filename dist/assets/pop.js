...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/pop.js");
/******/ })
/************************************************************************/
/******/ ({
...
var _header = __webpack_require__(/*! ./container/header */ "./src/container/header/index.jsx");

var _header2 = _interopRequireDefault(_header);

var _preview = __webpack_require__(/*! ./container/preview */ "./src/container/preview/index.jsx");

var _preview2 = _interopRequireDefault(_preview);

var _settings = __webpack_require__(/*! ./container/settings */ "./src/container/settings/index.jsx");
...
var _Wrapper = __webpack_require__(/*! ./Wrapper */ "./src/Wrapper.jsx");
...
/* import styles */
var Provider = _Wrapper2.default.Provider;
/* main */
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.search = function (val) {
      ...
      posts.forEach(function (itemPost) {
        var title = itemPost.title.toLowerCase();
      ...
      _this.setState(Object.assign({}, _this.state, { posts: posts }));
    };

    _this.name = 'Read Later';
    _this.style = _app2.default;
  ...
  (0, _createClass3.default)(App, [{
    ...
    value: function getIcon(url) {
      var src = this.state.settings.favicon_api ? '' + this.state.settings.favicon_api + url.replace(/^(https|http):\/\//, '') : url.match(/(^[a-zA-z]+:\/\/).*?\//)[0] + '/favicon.ico';

      return src;
    }
  }, {
    key: 'addPost',
    value: function addPost(details, postList) {
      var url = details.url,
          id = details.id,
          title = details.title;

      var imgsrc = this.getIcon(url);

      postList.push({ url: url, id: id, title: title, imgsrc: imgsrc, show: true });
    }
  }, {
    key: 'updateState',
    value: function updateState(posts) {
    ...
    value: function clear() {
      ...
      chrome.runtime.sendMessage({
        ...
        _this4.setState({ posts: [] });
      });
    }
  }, {
    key: 'updateSetting',
    value: function updateSetting(type, data) {
      switch (type) {
        case 'reset':
          ...
          break;
        case 'save':
          chrome.runtime.sendMessage({ type: 'save_settings', data: data });
          this.setState({ settings: data });
          break;
        default:
          break;
...
module.exports = { "core": "app__core___20EMV" };
...
var _style = __webpack_require__(/*! ./style.scss */ "./src/components/post/style.scss");
  ...
  (0, _createClass3.default)(Post, [{
    ...
    value: function setIcon() {
      ...
      setTimeout(function () {
        if (!_this2.complete) {
          // ^(https|http)?:\/\/.*\/
          _this2.el.setAttribute('src', _this2.props.settings.img_default);
        }
      }, this.props.settings.img_timeout);
    }
  }, {
    key: 'initLoad',
    value: function initLoad(el) {
      if (el) {
        this.el = el;
      }
    ...
    value: function render() {
      ...
      var coreClassName = show ? this.style.core : this.style.core + ' ' + this.style.coreHidden;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { className: this.style.coreLink, href: url, target: '_blank' },
          title
        ),
...
// removed by extract-text-webpack-plugin
module.exports = { "core": "style__core___3o0br", "coreIcon": "style__coreIcon___3J5g_", "coreRemove": "style__coreRemove___2b-Wt", "coreLink": "style__coreLink___1xwNh", "coreHidden": "style__coreHidden___2_mTt" };
...
var _style = __webpack_require__(/*! ./style.scss */ "./src/components/search/style.scss");
  ...
  (0, _createClass3.default)(Search, [{
    ...
    value: function search() {
      ...
      input = setTimeout(function () {
        ...
        _this2.searching(value);
      }, 300);
    }
  }, {
    key: 'searching',
    value: function searching(val) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('span', { className: this.style.coreRemove, onClick: function onClick() {
            return _this3.clear();
          } })
      );
    }
...
// removed by extract-text-webpack-plugin
module.exports = { "core": "style__core___V9zfc", "coreRemove": "style__coreRemove___1kcNE" };
...
var _style = __webpack_require__(/*! ./style.scss */ "./src/components/settingsItem/style.scss");
...
var SettingsItem = function (_Component) {
  (0, _inherits3.default)(SettingsItem, _Component);

  function SettingsItem(props) {
    (0, _classCallCheck3.default)(this, SettingsItem);

    var _this = (0, _possibleConstructorReturn3.default)(this, (SettingsItem.__proto__ || Object.getPrototypeOf(SettingsItem)).call(this, props));

    _this.style = _style2.default;
    return _this;
  }

  (0, _createClass3.default)(SettingsItem, [{
    key: 'input',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'li',
        { className: this.style.settingsItem },
        _react2.default.createElement(
          'label',
          { htmlFor: name },
          title,
...
/***/ "./src/components/settingsItem/style.scss":
/*!************************************************!*\
  !*** ./src/components/settingsItem/style.scss ***!
  \************************************************/
/*! no static exports found */
...
// removed by extract-text-webpack-plugin
module.exports = { "settingsItem": "style__settingsItem___2L0Fd" };
...
var _style = __webpack_require__(/*! ./style.scss */ "./src/container/clear/style.scss");
...
var Consumer = _Wrapper2.default.Consumer;
...
var Clear = function (_Component) {
  ...
  function Clear(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Clear.__proto__ || Object.getPrototypeOf(Clear)).call(this, props));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        function (data) {
          ...
          return _react2.default.createElement(
            'button',
            { className: _this2.style.core, onClick: clear },
            'Clear'
          );
        }
      );
...
/***/ "./src/container/clear/style.scss":
/*!****************************************!*\
  !*** ./src/container/clear/style.scss ***!
  \****************************************/
/*! no static exports found */
...
// removed by extract-text-webpack-plugin
module.exports = { "core": "style__core___9a0rw" };

/***/ }),

/***/ "./src/container/empty/index.jsx":
/*!***************************************!*\
  !*** ./src/container/empty/index.jsx ***!
  \***************************************/
/*! no static exports found */
...
var _style = __webpack_require__(/*! ./style.scss */ "./src/container/empty/style.scss");
...
var Empty = function (_Component) {
  ...
  function Empty(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Empty.__proto__ || Object.getPrototypeOf(Empty)).call(this, props));
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          'you have 2 ways to add post.',
          ' '
        ),
        _react2.default.createElement(
          'p',
          null,
          "1. click context menu 'read later'.",
          ' '
        ),
        _react2.default.createElement(
          'p',
...
/***/ "./src/container/empty/style.scss":
/*!****************************************!*\
  !*** ./src/container/empty/style.scss ***!
  \****************************************/
/*! no static exports found */
...
// removed by extract-text-webpack-plugin
module.exports = { "empty": "style__empty___1sWjZ" };
...
var _style = __webpack_require__(/*! ./style.scss */ "./src/container/header/style.scss");
...
var Header = function (_Component) {
  ...
  (0, _createClass3.default)(Header, [{
    ...
    value: function openSettingsPanel() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: this.style.headerInfo },
          _react2.default.createElement(
            'h1',
            { className: this.style.headerInfoTitle },
            title
          ),
          _react2.default.createElement(
            'span',
        ...
        _react2.default.createElement('span', {
          ...
          title: 'settings',
          onClick: function onClick() {
            return _this2.openSettingsPanel();
          }
        }),
        _react2.default.createElement(
          'div',
          { className: this.style.headerContact },
          _react2.default.createElement(
            'a',
            {
              target: '_blank',
            ...
            _react2.default.createElement('span', { className: this.style.git })
          ),
          _react2.default.createElement(
            'a',
            {
            ...
            _react2.default.createElement('span', { className: this.style.email })
          )
        ),
        _react2.default.createElement(_search2.default, { search: search })
      );
    }
  }]);
  return Header;
...
/***/ "./src/container/header/style.scss":
/*!*****************************************!*\
  !*** ./src/container/header/style.scss ***!
  \*****************************************/
/*! no static exports found */
...
// removed by extract-text-webpack-plugin
module.exports = { "header": "style__header___39Dv1", "headerInfo": "style__headerInfo___ua0Ea", "headerInfoTitle": "style__headerInfoTitle___ewo2h", "headerContact": "style__headerContact___2Utmy", "git": "style__git___2Mbnn", "email": "style__email___1xrRW", "settings": "style__settings___3FSQv" };

/***/ }),

/***/ "./src/container/postList/index.jsx":
/*!******************************************!*\
  !*** ./src/container/postList/index.jsx ***!
  \******************************************/
/*! no static exports found */
...
var _style = __webpack_require__(/*! ./style.scss */ "./src/container/postList/style.scss");
...
var _post = __webpack_require__(/*! ../../components/post */ "./src/components/post/index.jsx");
...
var PostList = function (_Component) {
  ...
  function PostList(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (PostList.__proto__ || Object.getPrototypeOf(PostList)).call(this, props));
    ...
    value: function getPosts() {
      ...
      return this.props.posts.map(function (post) {
        ...
        return _react2.default.createElement(_post2.default, {
          ...
          remove: _this2.remove.bind(_this2)
        });
      });
    }
  }, {
...
/***/ "./src/container/postList/style.scss":
/*!*******************************************!*\
  !*** ./src/container/postList/style.scss ***!
  \*******************************************/
/*! no static exports found */
...
// removed by extract-text-webpack-plugin
module.exports = { "wrap": "style__wrap___3o6YP", "list": "style__list___1Mbb0" };

/***/ }),

/***/ "./src/container/preview/index.jsx":
/*!*****************************************!*\
  !*** ./src/container/preview/index.jsx ***!
  \*****************************************/
/*! no static exports found */
...
var _style = __webpack_require__(/*! ./style.scss */ "./src/container/preview/style.scss");
...
var _postList = __webpack_require__(/*! ../postList */ "./src/container/postList/index.jsx");

var _postList2 = _interopRequireDefault(_postList);

var _clear = __webpack_require__(/*! ../clear */ "./src/container/clear/index.jsx");

var _clear2 = _interopRequireDefault(_clear);

var _empty = __webpack_require__(/*! ../empty */ "./src/container/empty/index.jsx");
  ...
  (0, _createClass3.default)(Root, [{
    ...
    value: function removePost(id) {
      ...
      chrome.runtime.sendMessage({
        ...
        _this2.props.updateState(_this2.posts);
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      if (!posts || !posts.length) return _react2.default.createElement(_empty2.default, null);
...
var Preview = function Preview(props) {
  return _react2.default.createElement(
    ...
    null,
    function (data) {
      return _react2.default.createElement(Root, (0, _extends3.default)({}, data, props));
    }
  );
};
...
/***/ "./src/container/preview/style.scss":
/*!******************************************!*\
  !*** ./src/container/preview/style.scss ***!
  \******************************************/
/*! no static exports found */
...
// removed by extract-text-webpack-plugin
module.exports = { "core": "style__core___9uQMU" };
...
var _style = __webpack_require__(/*! ./style.scss */ "./src/container/settings/style.scss");
...
var _settingsItem = __webpack_require__(/*! ../../components/settingsItem */ "./src/components/settingsItem/index.jsx");
...
var Settings = function (_Component) {
  ...
  function Settings(props) {
    ...
    _this.folderName = _config2.default.title;
    _this.style = _style2.default;
    return _this;
  }
  ...
  (0, _createClass3.default)(Settings, [{
    ...
    value: function reset() {
      this.tempSettings = Object.assign({}, _config2.default);
    ...
    value: function getItems() {
      ...
      try {
        for (var _iterator = Object.keys(this.tempSettings)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var _key = _step.value;

          items.push(_react2.default.createElement(_settingsItem2.default, {
            key: _key,
            name: _key,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'section',
        {
          className: this.props.isOpen ? this.style.settings + ' ' + this.style.open : this.style.settings
        },
        _react2.default.createElement(
          'header',
          null,
        ...
        _react2.default.createElement(
          'div',
          { className: this.style.actions },
          _react2.default.createElement(
            'button',
            { className: this.style.reset, onClick: function onClick() {
                return _this2.reset();
              } },
            'reset'
          ),
          _react2.default.createElement(
            'button',
            { className: this.style.save, onClick: function onClick() {
                return _this2.save();
              } },
            'save'
          ),
...
/***/ "./src/container/settings/style.scss":
/*!*******************************************!*\
  !*** ./src/container/settings/style.scss ***!
  \*******************************************/
/*! no static exports found */
...
// removed by extract-text-webpack-plugin
module.exports = { "settings": "style__settings___3m7Dc", "list": "style__list___369UK", "open": "style__open___3N_ym", "actions": "style__actions___5RJw4", "save": "style__save___2aNmx", "reset": "style__reset___2yBS3" };
